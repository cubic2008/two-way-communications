...
function MessageEditor (props: MessageEditorProps) {
    ...
    // const [msgId, setMsgId] = useState(props.message === undefined ? -1 : props.message.id)
    // const [msgSubject, setMsgSubject] = useState(props.message === undefined ? '' : props.message.subject)
    // const [msgContent, setMsgContent] = useState(props.message === undefined ? '' : props.message.content)
    ...
    useEffect( () => {
        console.log("MessageEditor - init", `props.message.id = ${props.message.id}, props.displa = ${props.display}`)
        resetMessage()
    }, [props])
    ...
    // console.log("MessageEditor", `msgId = ${msgId}`)
    ...
    return (
        <div className="message-editor">
            ...
            { props.display && <>
                ...
                <Stack spacing={2} direction="row" sx={{'marginTop': '30px', 'display' : 'block'}} textAlign={'right'}>
                    <div>
